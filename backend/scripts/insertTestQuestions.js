...
const questions = [
  ...
  },
  {
    ...
    class_id: 1,
    page: 11,
    position: { x: 0.2, y: 0.25, w: 110, h: 60 },
  ...
  },
  {
    ...
    class_id: 1,
    page: 11,
    position: { x: 0.1, y: 0.45, w: 115, h: 50 },
  ...
  },
  {
    ...
    class_id: 1,
    page: 8,
    position: { x: 0.1, y: 0.3, w: 120, h: 50 },
  ...
  },
  {
    ...
    class_id: 1,
    page: 16,
    position: { x: 0.12, y: 0.4, w: 110, h: 55 },
...
async function insertTestQuestions() {
  try {
    ...
    for (const qData of questions) {
      ...
      console.log(
        `✅ 질문 저장: "${qData.text.substring(0, 30)}..." (작성자: ${randomStudent.name})`
      );
    }
